...
#SBATCH --error=log/STDRsubtrees.%A_%a.err
#SBATCH --output=log/STDRsubtrees.%A_%a.out
...
lookupFile=${scriptDir}/kingman_2000_STDR_RAxML_128.lst
combineScript=${scriptDir}/kingman_2000_STDR_RAxML_128.py
