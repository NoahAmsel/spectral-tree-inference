...
tree_rec = spectral_method.deep_spectral_tree_reonstruction(observations, reconstruct_tree.JC_similarity_matrix, taxon_namespace = reference_tree.taxon_namespace, threshhold = 35)
